...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      paywallOfferId: {
        type: 'string',
        description: 'Filter by associated offer',
      },
      startingAfter: {
        type: 'string',
...
export const handler = async (client: Heartbeat, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.signupPages.list(body)));
};
