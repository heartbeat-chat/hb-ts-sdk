...
import { ClientOptions } from '@heartbeat-chat/heartbeat';
...
export { ClientOptions } from '@heartbeat-chat/heartbeat';
...
export function initMcpServer(params: {
  ...
  const client = new Heartbeat(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Heartbeat({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
